...
int main() {
	...
	int main_method_n_for_problem_c = -1;
	int main_method_m_for_problem_c = -1;
	...
	int main_method_n_for_problem_d = -1;
	...
	// problem e code*****************************************************************
	int main_method_n_for_problem_e = -1;
	int sum_of_cycles_problem_e = 0;
